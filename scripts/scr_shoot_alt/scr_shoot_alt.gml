	...
	&& primary_action!=primary_actions.cutscene)
		...
		switch(weapon_slot[active_slot])
			...
			if(bullet_recharge[weapons.machinegun]<=0)
				...
				scr_set_starting_point_machinegun(primary_action, o_machinegun_bullet_alt)
				}
			break
			...
			if(bullet_recharge[weapons.spreadgun]==0)
				{
				audio_play_sound(o_controller.sound_array[6], 10, false)
				bullet_recharge[weapons.spreadgun]=16
				//instance_create(x+image_xscale*3, y, o_machinegun_bullet)
				scr_set_starting_point_spreadgun(primary_action, o_spreadgun_bullet_alt)
				}
			break
			...
			if(bullet_recharge[weapons.energygun]<=0)
				{
				audio_play_sound(o_controller.sound_array[6], 10, false)
				bullet_recharge[weapons.energygun]=20
				//instance_create(x+image_xscale*3, y, o_machinegun_bullet)
				scr_set_starting_point_energygun(primary_action, o_energygun_bullet_alt)
				}
			break
			...
			if(bullet_recharge[weapons.hominggun]<=0)
				{
				bullet_recharge[weapons.hominggun]=24
				//instance_create(x+image_xscale*3, y, o_machinegun_bullet)
				scr_set_starting_point_hominggun(primary_action, o_hominggun_bullet_alt)
				}
			break
			...
			if(bullet_recharge[weapons.lasergun]<=0)
				...
				//instance_create(x+image_xscale*3, y, o_machinegun_bullet)
				scr_set_starting_point_lasergun(primary_action, o_start_laser_alt)
				}
			break

...
scr_draw_text_outlined(x+(space*10)-10, y+(space*3), c_black, c_white,  string_hash_to_newline("P1"))
if(gamepad_is_connected(o_controller.gamepad_slot2))
	{
	scr_draw_text_outlined(x+(space*12)-10, y+(space*3), c_black, c_white, string_hash_to_newline("P2"))
	}
var i
...
if(key_waiting!=-1)
    {
    scr_draw_text_outlined(o_pause.screen_left+5, o_pause.screen_top+250, c_black, c_white, string_hash_to_newline(string("Push " + menu[key_waiting] + " button")))
    }    

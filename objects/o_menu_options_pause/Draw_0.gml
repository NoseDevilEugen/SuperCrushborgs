...
for(i=0; i<array_length(menu); i=i+1)
    {
    scr_draw_text_outlined(x+space, y+(i*space), c_black, c_white, string(menu[i]))
    }
...
scr_draw_text_outlined(x+space+space, y+(10*space),  c_black, c_white, string(message_for_player[mpos]))
